document.addEventListener('DOMContentLoaded', function () {
  ...
  function validateField(field) {
    ...
    if (field.maxLength && field.maxLength > 0 && value.trim().length > field.maxLength) {
  ...
  function collectAnimatableElements() {
    ...
    found.forEach(function (el) {
      if (!el.classList.contains('animation-registered')) {
        el.classList.add('animation-registered');
  ...
  function revealElements() {
    ...
    animatedElements.forEach(function (el) {
      ...
      var visiblePoint = windowHeight - (windowHeight * threshold);
      if (rect.top <= visiblePoint) {
    ...
    animatedElements = animatedElements.filter(function (el) {
      return !el.classList.contains('animation-done');
    });
  }

  var scrollAnimationObserver;
  ...
  if ('IntersectionObserver' in window) {
    ...
    function collectAndObserve() {
      var selectors = ['.fade-in', '.animate-on-scroll', '.reveal', '[data-animate]'];
      var found = document.querySelectorAll(selectors.join(', '));
      found.forEach(function (el) {
        if (!el.classList.contains('animation-registered')) {
          el.classList.add('animation-registered');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '639f58d6-2d28-4ad7-b7d4-01d0e7338a6c',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '639f58d6-2d28-4ad7-b7d4-01d0e7338a6c';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '639f58d6-2d28-4ad7-b7d4-01d0e7338a6c';
